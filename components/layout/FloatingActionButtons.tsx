    ...
    <div className="fixed bottom-6 right-6 z-[60] flex flex-col items-end gap-4 pointer-events-none">
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            className="w-12 h-12 bg-navy text-white rounded-full flex items-center justify-center shadow-lg hover:bg-navy/90 transition-colors pointer-events-auto"
      ...
      <div className="flex items-center gap-3 relative pointer-events-auto">
        ...
        <motion.a
          ...
          className="relative w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-xl z-10"
